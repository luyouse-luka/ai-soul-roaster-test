        ...
        <div className="h-full bg-black p-4 flex flex-col relative z-20 overflow-hidden">
          ...
          <div className="flex-1 border-2 border-green-500 bg-black relative p-6 flex flex-col items-center text-center shadow-[0_0_20px_rgba(0,255,0,0.3)] mt-4 mb-4">
             ...
             <div className="grid grid-cols-2 gap-4 w-full mb-6">
               <div className="flex flex-col items-center p-2 border border-red-900/50 bg-red-900/10 rounded">
                  <div className="text-xs text-red-400 mb-1">危险指数</div>
                  <div className="text-3xl font-black text-red-600">{result.dangerLevel}</div>
               </div>
               <div className="flex flex-col items-center p-2 border border-green-900/50 bg-green-900/10 rounded">
                  <div className="text-xs text-green-400 mb-1">人类得分</div>
                  <div className="text-3xl font-black text-green-500">{result.score}</div>
               </div>
             </div>

             <div className="w-full text-left space-y-2 mb-6 border-l-2 border-green-600 pl-4 bg-green-900/5 py-2">
                <div className="text-xs text-green-400">
                  <span className="opacity-50">幸运物品:</span> <span className="text-white font-bold">{result.luckyItem}</span>
                </div>
                <div className="text-xs text-green-400">
                  <span className="opacity-50">物种匹配:</span> <span className="text-white font-bold">{result.animalMatch}</span>
                </div>
             </div>
